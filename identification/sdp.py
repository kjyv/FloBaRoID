...
class SDP:
            ...
            if idf.opt["useSymmetryConstraints"] and idf.opt["symmetryConstraints"]:
                for a, b, sign in idf.opt["symmetryConstraints"]:
                    if (
                        ...
                        sym = Matrix([[eps, p_a - sign * p_b], [p_a - sign * p_b, 1]])
        ...
        with helpers.Timer() as t:
            ...
            if idf.opt["onlyUseDSDP"] or state != "optimal":
                ...
                solution, state = sdp_helpers.solve_sdp(
                    objective_func, lmis, variables, primalstart=prime, wide_bounds=True
                )
    ...
    def identifyFeasibleStandardParametersDirect(self, idf):
        ...
        with helpers.Timer() as t:
            ...
            U_rho = BlockMatrix(
                [
                    [Matrix([u - rho2_norm_sqr]), e_rho1.T],
    ...
    def findFeasibleStdFromFeasibleBase(self, idf, xBase):
        ...
        with helpers.Timer() as t:
            ...
            if onlyUseDSDP or state != "optimal":
                ...
                solution, state = sdp_helpers.solve_sdp(
                    objective_func, lmis, variables, primalstart=xStd, wide_bounds=True
                )
                sdp_helpers.solve_sdp = sdp_helpers.cvxopt_conelp
