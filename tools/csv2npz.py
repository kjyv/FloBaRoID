...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--robot",
        required=True,
        help="which robot to import data for (walkman, centauro)",
        type=str,
    )
    ...
    if args.robot == "walkman":
        ...
        data.preprocess(
            ...
            T=out["times"],
            Fs=out["frequency"],
            IMUlinVel=out["IMUlinVel"],
            IMUrotVel=out["IMUrotVel"],
            IMUlinAcc=out["IMUlinAcc"],
            IMUrotAcc=out["IMUrotAcc"],
            IMUrpy=out["IMUrpy"],
    ...
    if config["floatingBase"]:
        np.savez(
            ...
            torques=out["torques"],
            torques_raw=out["torques_raw"],
            base_velocity=out["base_velocity"],
            base_acceleration=out["base_acceleration"],
            base_rpy=out["base_rpy"],
